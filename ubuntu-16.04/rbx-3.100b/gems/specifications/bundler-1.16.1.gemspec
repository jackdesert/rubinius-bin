...
Gem::Specification.new do |s|
  ...
  s.authors = ["Andr\xC3\xA9 Arko".freeze, "Samuel Giddins".freeze, "Chris Morris".freeze, "James Wen".freeze, "Tim Moore".freeze, "Andr\xC3\xA9 Medeiros".freeze, "Jessica Lynn Suttles".freeze, "Terence Lee".freeze, "Carl Lerche".freeze, "Yehuda Katz".freeze]
  s.bindir = "exe".freeze
  s.date = "2017-12-21"
